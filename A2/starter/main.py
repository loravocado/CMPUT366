...
def main():
    ...
    for i in range(0, len(start_states)):   
        ...
        cost, expanded_astar = solutions.run_a_star(start, goal, gridded_map) # Replace None, None with a call to your implementation of A*
        ...
        cost, expanded_mm = solutions.run_mm(start, goal, gridded_map) # Replace None, None with a call to your implementation of MM
        ...
        cost, expanded_biastar = solutions.run_bi_a_star(start, goal, gridded_map) # Replace None, None with a call to your implementation of Bi-A*
